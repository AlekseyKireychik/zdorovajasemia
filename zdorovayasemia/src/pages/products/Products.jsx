        ...
        <div className={style.container}>
          ...
          <section className={style.product}>
            <div className={style.productText}>
              <h3>Орто-покрытия</h3>
              <span>
                При ежедневном использовании орто-покрытия можно решить
                следующие проблемы:
              </span>
              <ul>
              ...
              <p>
                ...
                Пазлы легко мыть и собирать вновь, предавать новые формы
                (квадрат, прямоугольник, дорожка, ступеньки, классики)⠀
              </p>
              <p>
                Со временем ребёнок забывает делать упражнения. Положите коврик
                в ванной, в проходном коридоре или на кухне и вся семья без
          ...
          <section className={style.product}>
            <div className={style.productText}>
              ...
              <span>
                <b>
                  Шина Фрейка даёт возможность фиксации бедер ребенка в
                  положении отведения и сгибания под углом большим или равным
                  90°.
                </b>
              </span>
              <p>
          ...
          <section className={style.product}>
            <div className={style.productText}>
              ...
              <p>
                Корректор нужно носить в течение 3-4 месяцев около 3 часов в
                день желательно при сидячем виде работы.
              </p>
              <p>
              ...
              <p>
                ...
                сутулиться, то правильно подобранный пояс будет натирать в
                области подмышек или на груди.
              </p>
              <span>ПОКАЗАНИЯ:</span>
              <ul>
          ...
          <section className={style.product}>
            <div className={style.productText}>
              ...
              <ul>
                <li>
                  Тренирует вестибулярный аппарат, координацию движения и
                  гибкость
                </li>
          ...
          <section className={style.product}>
            <div className={style.productText}>
              ...
              <p>
                Плосковальгусные (х-образные) ноги хорошо поддаются лечению
                именно у детей в раннем возрасте. И основой лечения являются
                ортопедические стельки, обувь.
              </p>
              <p>
                У каждого ребенка на сезон приходится 3-4 пары обуви. Купить
                ортопедическую обувь не всегда есть возможность. А стельки
                удобны в применении и доступны по ценам. Легко переставляются с
                одной пары в другую. Но желательно иметь 2 пары стелек, чтобы
                была возможность просушить их после носки.
              </p>
              <span>
          ...
          <section className={style.product}>
            <div className={style.productText}>
              <h3>МЯЧ ФИТБОЛ </h3>
              <span>
                МЯЧ ФИТБОЛ антивзрыв 75 см снижает мышечный гипертонус (а он,
                как правило, встречается у 90 % малышей).
              </span>
              <ul>
                <li>Тренирует координацию и вестибулярный аппарат;</li>
                <li>
                  Поможет справиться с желудочными и кишечными коликами,
                  вздутием;
                </li>

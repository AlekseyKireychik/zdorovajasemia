...
const servicesDate = [
  ...
  },
  {
    ...
    titleList: "Курс массажа 10 сеансов способен решить следующие проблемы:",
    items: [
  ...
  },
  {
    ...
    subTitleList: "ГЛАВНАЯ ЦЕЛЬ и ЗАДАЧА это:",
    subItems: [
  ...
  },
  {
    ...
    titleList: "Эффекты кинезиотейпинга:",
    items: [
      "обезболивающий;",
    ...
    titleListTwo: "Кинезиотейпинг эффективен в лечении:",
    itemsTwo: [
      "растяжений связок;",
...
// const listItems = servicesDate.map(item => {
//   return item.items;
// });

      ...
      <div className={style.container}>
        <div className={style.content}>
          ...
          <ul className={style.list}>
            ...
            <li className={style.item}>
              <h3 className={style.subtitle}>Профессионализм</h3>Команде центра
            ...
            <li className={style.item}>
              <h3 className={style.subtitle}>Комфорт</h3>Всегда идем на встречу к нашим клиентам и подбираем удобное для них время.
            </li>
          </ul>
        </div>
